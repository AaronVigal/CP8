...
adi_ip_add_core_dependencies { \
  afrl.mil:user:util_puf_core:1.0 \
  afrl.mil:user:util_axis_puf_controller:1.0 \
  afrl.mil:user:util_axis_puf_string_encoder:1.0 \
  afrl.mil:user:util_axis_puf_string_decoder:1.0 \
