...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "slave_width" -parent ${Page_0}
...
proc update_PARAM_VALUE.slave_width { PARAM_VALUE.slave_width } {
	# Procedure called to update slave_width when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.slave_width { PARAM_VALUE.slave_width } {
	# Procedure called to validate slave_width
	return true
}


proc update_MODELPARAM_VALUE.slave_width { MODELPARAM_VALUE.slave_width PARAM_VALUE.slave_width } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.slave_width}] ${MODELPARAM_VALUE.slave_width}
}
